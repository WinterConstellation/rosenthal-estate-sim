...
import {
  GlyphAtmosphereCanvas,
  applyGlyphAtmospherePresentation,
  createGlyphAtmosphereEffect,
  getGlyphAtmosphereFormat,
} from "./effects/GlyphAtmosphereCanvas.jsx";
...
function resolveHorrorDirector(game, isNight) {
  ...
  return {
    ...
    glyphAtmosphere: createGlyphAtmosphereEffect(isNight, intensity),
    staticRows: {
...
function resolveUiPresentation(game, isNight, horrorDirector) {
  ...
  return {
    ...
    uiStage,
    preset,
    glyphFormat: getGlyphAtmosphereFormat(preset, isNight),
...
function applyDeveloperUiOverrides(presentation, uiPreset) {
  ...
  return {
    ...
    uiStage,
    preset,
    glyphFormat: getGlyphAtmosphereFormat(preset, timePhase === "night"),
    allowHorrorLayers: uiStage !== "calm",
    previewIntensity,
...
function applyUiPresentationToHorrorDirector(director, presentation) {
  ...
  return {
    ...director,
    intensity,
    glyphAtmosphere: applyGlyphAtmospherePresentation(director.glyphAtmosphere, presentation, intensity),
    textMist: {
      ...director.textMist,
