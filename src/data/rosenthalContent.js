...
export const DAY_ACTIONS = [
  ...
  day("interaction", "maid-tea", "메이드와 차를 마신다", "메이드는 차를 천천히 따르고, 오늘의 일정을 차분히 설명했다. 맞은편 빈 의자에도 잔받침 하나가 놓여 있었다.", { estate: { trust: 3 }, stats: { charm: 1, stamina: -1 } }, "gain", { npcId: "maid", firstDaySafe: true }),
  ...
  day("investigation", "seven-ledgers", "첫날 장부를 확인한다", "장부의 분류는 놀랄 만큼 깔끔했다. 다만 마지막 서명란에는 이미 당신의 이름을 연습한 흔적이 남아 있다.", { stats: { insight: 3, stamina: -2 }, estate: { recordIntegrity: 3, corruption: 1 } }, "gain-heavy", { firstDaySafe: true }),
  ...
  day("training", "breathing", "호흡과 보법을 익힌다", "마당의 공기는 맑고, 짧은 훈련 뒤에도 몸은 생각보다 가볍다. 복도 끝의 발소리도 당신의 박자에 맞춰 잠시 멎었다.", { stats: { resolve: 2, stamina: -2 }, resources: { fear: -1 } }, "gain", { firstDaySafe: true }),
  ...
  day("rest", "garden-walk", "정원을 천천히 걷는다", "정원은 잘 손질되어 있고 햇빛도 부드럽다. 정원사는 같은 꽃이 매주 한 송이씩 줄어드는 것만 빼면 좋은 계절이라고 말했다.", { stats: { health: 1, insight: 1, stamina: 2 }, resources: { fear: -1 } }, "gain", { firstDaySafe: true }),
...
export const PROLOGUE = [
  ...
  "창가의 탁자에는 따뜻한 차와 아직 마르지 않은 잉크가 놓여 있다.",
  "이곳이 내가 살던 세계와는 전혀 다른 곳이라는 사실을 깨닫기까지는, 그리 오랜 시간이 걸리지 않았다.",
  "낯선 표지들은 이상하게도 읽히고, 복도는 오래 머문 집처럼 발에 익다.",
  "나는 분명…….",
  "문을 두드리는 소리와 함께, 단정한 복장의 메이드가 들어와 고개를 숙인다.",
  "허리에는 오래 손질한 열쇠꾸러미와 짧은 호신검이 얌전히 걸려 있었다.",
  "“좋은 아침입니다, 영주님.”",
  "당신은 이 세계의 언어도, 저택의 구조도, 영지의 법도 모른다.",
  "그런데도 말은 들리고, 쌓인 서류들은 당신이 오래전부터 결재하던 것처럼 정리되어 있다.",
  "모든 사람이 친절하다. 당신이 방금 도착했다는 사실을, 아무도 묻지 않는다.",
  "서류 첫 장에는 당신의 이름과 오늘 아침의 날씨가 이미 적혀 있다.",
  "식탁에는 두 사람분의 차가 준비되어 있고, 맞은편 의자는 비어 있다.",
  "메이드는 미소를 유지한 채 한 박자 빠르게 다음 일정을 펼친다.",
  "어째서?",
];
