...
const day = (category, id, title, result, effects, balance, extra = {}) => ({
  id, category, title, result, effects, balance, tone: ["loss", "loss-heavy"].includes(balance) ? "danger" : "neutral", ...extra,
});

export const DAY_ACTIONS = [
  day("gathering", "fields", "남쪽 밭의 수확을 돕는다", "해가 기울 무렵 곡물 자루가 창고로 들어온다.", { resources: { food: 6 }, stats: { stamina: -2 } }, "gain"),
  ...
  day("interaction", "maid-tea", "메이드와 차를 마신다", "메이드는 차를 세 번 따랐다. 세 번째 잔은 아무도 마시지 않았다.", { estate: { trust: 3 }, stats: { charm: 1, stamina: -1 } }, "gain", { npcId: "maid" }),
  ...
  day("investigation", "seven-ledgers", "이전 영주의 장부를 조사한다", "모든 장부는 일곱째 날에서 끝난다. 여덟째 장은 뜯긴 것이 아니라 처음부터 없었다.", { stats: { insight: 3, stamina: -2 }, estate: { recordIntegrity: 3, corruption: 1 } }, "gain-heavy"),
  ...
  day("training", "breathing", "호흡과 보법을 익힌다", "숨을 고르는 동안 복도 끝의 발소리도 함께 멎었다.", { stats: { resolve: 2, stamina: -2 }, resources: { fear: -1 } }, "gain"),
  ...
  day("rest", "garden-walk", "정원을 천천히 걷는다", "정원사는 매주 같은 꽃이 한 송이씩 줄어든다고 말했다.", { stats: { health: 1, insight: 1, stamina: 2 }, resources: { fear: -1 } }, "gain"),
  ...
  day("other", "hold-audience", "주민들의 청원을 받는다", "사소한 부탁을 해결하자 사람들은 진심으로 안도했다.", { estate: { trust: 5, stability: 2 }, stats: { charm: 1, stamina: -4 }, resources: { silver: -3 } }, "gain-heavy"),
