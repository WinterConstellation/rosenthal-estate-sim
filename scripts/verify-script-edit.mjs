...
assert.equal(ids.has("tutorial:night-entry:1:speaker"), true);
assert.equal(ids.has("tutorial:night-entry:2:speaker"), true);
assert.equal(ids.has("tutorial:night-entry:3:speaker"), true);
...
const tutorialNightEntrySpeakerOne = index.entries.find((entry) => entry.id === "tutorial:night-entry:1:speaker");
assert.equal(tutorialNightEntrySpeakerOne.kind, "speaker");
